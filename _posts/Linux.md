...
![image-20201214104538466](D:\workSpace\LearningNotes\Redis\系统结构.png)
...
- **/srv** ：该目录存放一些服务启动之后需要提成都、取的数据。
- **/sys**：这是linux2.6内核的一个很大的变化。该目录下安装了2.6内核中新出现的一个文件系统 sysfs 。
- **/tmp**：这个目录是用来存放一些临时文件的，用完即丢的文件，可以放在这个目录下，安装包。
- **/usr** ：这是一个**非常重要**的目录，用户的很多应用程序和文件都放在这个目录下，类似于windows下的program files目录。
- **/usr/bin：** 系统用户使用的应用程序。
...
![image-20201214111044715](pwd.png)
